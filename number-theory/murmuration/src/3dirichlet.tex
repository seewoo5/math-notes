...
For short intervals, RH and the prime number theorem imply \ber unconditional result with larger $\gamma$ exists \er
\[
...
By applying the Polya--Vinogradov inequality \ber This is not exactly Polya--Vinogradov but more like a corollary\er
\begin{equation}
    \label{eqn:pv}
