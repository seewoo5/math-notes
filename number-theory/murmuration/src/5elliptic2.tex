...
The main idea of the proof of Theorem \ref{thm:sawin-sutherland} is the following Voronoi summation formula, where the summation over $n$ instead of primes is built-in inside the formula.
...
You can find more about the work from Sutherland's lecture \cite{sutherland} at Tate conference (\emph{The legacy of John Tate, and beyond} at Harvard university).
