...
He conjectured that we do have murmurations in such general cases for ``arithmetically compatible sequences of $(N, Q)$'' \cite[Conjecture 1.8]{martin2025distribution}, and computed the murmuration density for small $y = P / X$.
