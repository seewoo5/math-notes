...
If you find any typos or errors, please contact \href{mailto:seewoo5@berkeley.edu}{seewoo5@berkeley.edu}.

\newpage

\input{0introduction.tex}
\input{1doublecosets.tex}
\input{2ointcompacttori.tex}
\input{3ointsplittori.tex}
\input{4matchingfunctions.tex}
\input{5ointunram.tex}
\input{6reviewlocalGL2.tex}
\input{7globalointsplittori.tex}
\input{8eisensteinkernel.tex}
\input{9globalointcompacttori.tex}
\input{10fundamental.tex}
\input{11waldspurger.tex}
